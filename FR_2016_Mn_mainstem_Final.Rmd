---
title: "Feather River 2016 Mean Mainstem"
...
```{r}
  ...
  metricPath <- "D:/OneDrive/work/research/CHaMP/CHaMP_data/Feather/mainstem/2016/metrics"
  ...
  modelPath <- "D:/OneDrive/work/research/CHaMP/CHaMP_data/Feather/Mainstem/2016/Mean/"
...
```{r, message=FALSE}
  ...
  LST.in <- read.csv("D:/OneDrive/work/research/CHaMP/GIS/coverages/Feather_River/FR_16_LST.csv")
  PointID <- LST.in[,1]
  LST.in <- LST.in[,2:47]
...
```{r}
  ...
  write.dbf(CLST.out, file = paste0("D:/OneDrive/work/research/CHaMP/CHaMP_data/Feather/mainstem/2016/LST16_FR_interp.dbf"))
  
  
```
This part calculates the zonal mean of the daily LST for each RCA
```{r}
out_Preds <- read.dbf("D:/OneDrive/work/research/CHaMP/CHaMP_data/Feather/mainstem/2016/LST16_FR_interp.dbf")
...
```{r}
  ...
  write.dbf(rca_zonal, file = paste0("D:/OneDrive/work/research/CHaMP/CHaMP_data/Feather/mainstem/2016/LST16_FR_RCA.dbf"))
  
```
Discharge data formatting
```{r}

  Dv.in <- read.csv("D:/OneDrive/work/research/CHaMP/CHaMP_Data/Feather/mainstem/2016/FR_dv_datamain_2016.csv", stringsAsFactors = FALSE)
...
write.csv(Dv.8Day.out, paste0("D:/OneDrive/work/research/CHaMP/CHaMP_data/Feather/mainstem/2016/FR_2016_Dv_8Day_main", ".csv"), row.names = FALSE)
...
```{r}
  Log.in <- read.csv("D:/OneDrive/work/research/CHaMP/CHaMP_data/Feather/mainstem/2016/FR_loggermain_8D_2016.csv", stringsAsFactors = FALSE)
 

  ID.in <- read.csv("D:/OneDrive/work/research/CHaMP/GIS/coverages/Feather_River/FR_sites_rca_elev_2016main.csv", stringsAsFactors = FALSE) 
  
  LST.in <- read.dbf(paste0("D:/OneDrive/work/research/CHaMP/CHaMP_data/Feather/mainstem/2016/LST16_FR_RCA.dbf"))
  colnames(LST.in)<-gsub("X", "", colnames(LST.in))
  newnamesnum <- as.numeric(colnames(LST.in)[1:46]);
  Dv.in <- read.csv("D:/OneDrive/work/research/CHaMP/CHaMP_data/Feather/mainstem/2016/FR_2016_Dv_8Day_main.csv", stringsAsFactors = FALSE)
...
```{r}
  pred.y <- read.csv(paste0("jk_pred_v_y_", var, "_", basin, "_mainstem", yearPath, "_sp_fall.csv"), stringsAsFactors = FALSE, header = FALSE)
...
```{r}
  ...
  Log.in <- read.csv(paste0("D:/OneDrive/work/research/CHaMP/CHaMP_data/Feather/mainstem/2016/FR_loggermain_8D_2016.csv"), stringsAsFactors = FALSE)
  
  ID.in <- read.csv(paste0("D:/OneDrive/work/research/CHaMP/GIS/coverages/Feather_River/FR_sites_rca_elev_2016main.csv"), stringsAsFactors = FALSE) 
...
```{r}
  ...
  ptsname <- paste0("TempSiters_2016_RCAs_mainstem")
...
setwd(paste0(modelPath, "/graphics/"))
  ...
  system('"C:/Program Files/ImageMagick-7.0.1-Q16/convert.exe" -delay 20 -morph 3 *.png FR_2016_8D_Mn_mainstem.mpeg')
```
