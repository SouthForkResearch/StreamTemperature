...
```{r}
  ind <- apply(NoNA.xyz, 1, function(x) !any(is.na(x)))
  NoNA.xyz <- NoNA.xyz[ind,]
...
```{r, message=FALSE}
  ...
  error_pts@data <- error_pts@data[,c(1:2)]
...
setwd(paste0(modelPath, "/graphics/"))
  ...
  system('"C:/Program Files/ImageMagick-7.0.1-Q16/convert.exe" -delay 20 -morph 3 *.png Tucannon_2013_8D_Mx.mpeg')
```
