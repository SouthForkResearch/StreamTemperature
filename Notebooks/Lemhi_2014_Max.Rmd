...
library(uuid)
  ...
  var <- "Mx"
  longVar <- "Max"
  dataVar <- "Mx8Day" #name of the variable in the logger data
  capVar <- "MAX"
...
setwd(paste0(modelPath, "/graphics/"))
  ...
  system('"C:/Program Files/ImageMagick-7.0.1-Q16/convert.exe" -delay 20 -morph 3 *.png Tucannon_2014_8D_Mn.mpeg')
```
