---
title: "South Fork John Day 2016 Min"
...
```{r}
  ...
  Log.in <- read.csv(paste0(dataPath, midBasin, "_logger_8D_", yearPath, ".csv"), stringsAsFactors = FALSE)
  ...
  write.csv(x=Log.in, file=paste0("../../", basin, "_logger_8D_", yearPath, ".csv"), row.names=FALSE)
```
...
setwd(paste0(modelPath, "/graphics/"))
  ...
  system('"C:/Program Files/ImageMagick-7.0.1-Q16/convert.exe" -delay 15 -morph 3 *.png SFJD_2016_8D_Min.mpeg')
```
...
```{r}
  ...
  filename <- paste0(modelPath, "/graphics/Stills/", basin, "_", yearPath, "_8D_", var, ".png", sep="")
    png(filename=filename, res = 300, width = 1600, height = 1500, units = "px", bg="white")
        ...
        legend( x=grconvertX(c(0.89,0.95), from='npc'), 
        y=grconvertY(c(0.7, 0.95), from='npc'), fill = attr(fix3.colors, "palette"), title=paste0("8-day ", var, " (°C)"),legend = c("0-6","6-8","8-10","10-12","12-14","14-16","16-18","18-20", "20-22", "22+"), bty = "n", cex=.5, inset=c(0,0), text.col="black");
