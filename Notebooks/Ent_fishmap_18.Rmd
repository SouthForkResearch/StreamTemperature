...
```{r}
  for (i in 61:72) #July 1-Sept 30 2011 1:12, 2012 13:24, 2013 25:36, 2014 37:48, 2015 49:60, 2016 61:72  #25:36 
    ...
    legend(x=grconvertX(c(0.78, 0.95), from='npc'),
             y=grconvertY(c(0.35, 0.55), from='npc'), fill = c("#0000CD", "#C1CDCD"), title="8-day mean max", legend = c("< 18 °C", "> 18 °C"), bty = "n", cex=.5, inset=c(.1,0), text.col="white");
...
setwd(paste0(otherOutPath, "/graphics/"))
  ...
  system('"C:/Program Files/ImageMagick-7.0.1-Q16/convert.exe" -delay 15 -morph 3 *.png Ent_Chinook_18.mpeg')
```
...
```{r}
    ...
    legend(x=grconvertX(c(0.78, 0.95), from='npc'),
             y=grconvertY(c(0.35, 0.55), from='npc'), fill = c("#0000CD", "#C1CDCD"), title="8-day mean max", legend = c("< 18 °C", "> 18 °C"), bty = "n", cex=.5, inset=c(.1,0), text.col="black");
