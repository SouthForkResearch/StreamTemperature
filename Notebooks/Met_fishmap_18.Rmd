...
```{r}
  for (i in 61:72) #July 1-Sept 30 2011 1:12, 2012 13:24, 2013 25:36, 2014 37:48, 2015 49:60, 2016 61:72  #25:36 
    ...
    legend(x=grconvertX(c(0.84, 0.95), from='npc'),
      ...
      title(paste0("Available Chinook holding and spawning habitat in the ", nameBasin,", 1 July - 30 Sept, 2011-2016"), line=-0.1, adj=1.0, col.main="white", col.sub="white", outer=FALSE, cex.main=0.6, cex.sub=0.5)
      ...
      #change xlim
       tmp2 <- subplot(
        plot(sequ[1:i], dispPerc[1:i], type="l", col="lightblue", bty="n", ylim=c(0,100), xlim=c(1,72), xlab="    2011    2012    2013    2014    2015    2016", ylab="", cex.lab=.98, cex.main=.95, main="Percent usable stream length", adj=0, line=.5, col.lab="white", col.main = "white", cex.axis=0.6, col.axis="white", bg="black", yaxp=c(0,100,2), xaxp=c(2011,2013,2)),
...
setwd(paste0(otherOutPath, "/graphics/"))
  ...
  system('"C:/Program Files/ImageMagick-7.0.1-Q16/convert.exe" -delay 15 -morph 3 *.png Met_Chinook_18.mpeg')
```
...
```{r}
      i <- length(dispPerc)
      j <- m-24 # pull this from the appropriate year 2011 i+24, 2012 i+12, 2013 i, 2014 i-12, 2015 i-24, 2016 i-36
    ...
    par(oma=c(0,0,0,0))
      ...
      mtext(paste0(yearPath),side =1, outer=TRUE, line=-3, col="black", cex=.75)
       ...
       tmp2 <- subplot(
        plot(sequ[1:i], dispPerc[1:i], type="l", col="blue", bty="n", ylim=c(0,100), xlim=c(1,72), xlab="    2011    2012    2013    2014    2015    2016", ylab="", cex.lab=.82, cex.main=.8, main="Percent usable stream length", adj=0, line=.5, col.lab="black", col.main = "black", cex.axis=0.6, col.axis="black", bg="white", yaxp=c(0,100,2), xaxp=c(2011,2016,2)),
