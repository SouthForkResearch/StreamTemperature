...
```{r}
  ...
  rca <- subset(rcas, STHD_IP == "Steelhead") 
...
images
```{r}
  for (i in 52:68) # 2011 1:17, 2012 18:34, 2013 35:51, 2014 52:68, 2015 69:85, 2016 86:102;   7-23 
    {
      
      j <- i-45 # 2011 i+6, 2012 i-11, 2013 i-28, 2014 i-45, 2015 i-62, 2016 i-79
    ...
    legend(x=grconvertX(c(0.46, 0.59), from='npc'),
             y=grconvertY(c(0.0, 0.06), from='npc'), fill = c("lightblue", "cyan2"), legend = c("> 2 °C", "> 4 °C"), bty = "n", cex=.4, inset=c(0,0), text.col="white");
      
      title(paste0("Available steelhead spawning habitat in the ", nameBasin,", 1 Feb - 15 June, 2011-2015"), line=-0.1, adj=.80, col.main="white", col.sub="white", outer=FALSE, cex.main=0.6, cex.sub=0.5)
      ...
      #change xlim
       tmp2 <- subplot(
        plot(sequ[1:i], dispPerc[1:i], type="l", col="lightblue", bty="n", ylim=c(0,100), xlim=c(1,102), xlab="   2011    2012    2013    2014    2015", ylab="", cex.lab=.9, cex.main=.8, main="Percent usable stream length", adj=0, line=.5, col.lab="white", col.main = "white", cex.axis=0.6, col.axis="white", bg="black", yaxp=c(0,100,2), xaxp=c(2011,2016,2)),
       ...
       tmp2 <- subplot(
        plot(sequ[1:i], dispPerc2[1:i], type="l", col="cyan2", bty="n", ylim=c(0,100), xlim=c(1,102), xlab="", ylab="", cex.lab=.9, cex.main=.8, main="", adj=0, line=.5, col.lab="white", col.main = "white", cex.axis=0.6, col.axis="white", bg="black", yaxp=c(0,100,2), xaxp=c(2011,2016,2)),
...
setwd(paste0(otherOutPath, "/graphics/"))
  ...
  system('"C:/Program Files/ImageMagick-7.0.1-Q16/convert.exe" -delay 15 -morph 3 *.png Sec_STHD_4.mpeg')
```
...
```{r}
      i <- length(dispPerc)
      j <- m-45 # pull this from the appropriate year 2011 i+6, 2012 i-11, 2013 i-28, 2014 i-45, 2015 i-62, 2016 i-79
    ...
    legend(x=grconvertX(c(0.80,0.99), from='npc'), 
      ...
      title(paste0("Available Steelhead spawning habitat in the ", nameBasin,", 1 Feb - 15 June, 2011-2015"), line=-0.1, adj=.80, col.main="black", col.sub="black", outer=FALSE, cex.main=0.6, cex.sub=0.5)
      ...
      mtext(paste0(yearPath),side =1, outer=TRUE, line=-3, col="black", cex=.75)
       ...
       tmp2 <- subplot(
        plot(sequ[1:i], dispPerc[1:i], type="l", col="lightblue", bty="n", ylim=c(0,100), xlim=c(1,102), xlab="  2011   2012   2013   2014   2015", ylab="", cex.lab=.9, cex.main=.8, main="Percent usable stream length", adj=0, line=.5, col.lab="black", col.main = "black", cex.axis=0.6, col.axis="black", bg="white", yaxp=c(0,100,2), xaxp=c(2011,2016,2)),
       ...
       tmp2 <- subplot(
        plot(sequ[1:i], dispPerc2[1:i], type="l", col="cyan2", bty="n", ylim=c(0,100), xlim=c(1,102), xlab="", ylab="", cex.lab=.9, cex.main=.8, main="", adj=0, line=.5, col.lab="black", col.main = "black", cex.axis=0.6, col.axis="black", bg="white", yaxp=c(0,100,2), xaxp=c(2011,2016,2)),
...
```{r}
  ...
  plot(sequ[1:j], dispPerc[1:j], type="l", col="lightblue", bty="n", ylim=c(0,110), xlim=c(1,102),
       ...
       xlab="     2011      2012        2013        2014        2015", ylab="", cex.lab=.5, cex.main=.4, 
       main=paste0("Steelhead spawning habitat in the ", nameBasin, " under ", temp, " & ", temp2, " °C, 1 Feb - 15 June, 2011-2015 \n \n Percent usable stream length"), adj=0, line=0.1, col.lab="black", col.main = "black", 
       cex.axis=0.5, col.axis="black", bg="white", yaxp=c(0,100,2), xaxp=c(2011,2015,2))
  points(sequ[1:j], dispPerc2[1:j], type="l", col="cyan2") 
  legend(x=grconvertX(c(0.84, 0.99), from='npc'),
         y=grconvertY(c(0.2, 0.1), from='npc'),
