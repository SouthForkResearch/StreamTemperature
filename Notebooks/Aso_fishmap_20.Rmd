...
```{r}
  for (i in 81:96) #June 10-Oct 15 2011 1:16, 2012 17:32, 2013 33:48, 2014 49:64, 2015 65:80, 2016 81:96  #21:36 
    ...
    legend(x=grconvertX(c(0.80, 0.99), from='npc'),
      ...
      #change xlim
       tmp2 <- subplot(
        plot(sequ[1:i], dispPerc[1:i], type="l", col="lightblue", bty="n", ylim=c(0,100), xlim=c(1,96), xlab="2011  2012  2013  2014  2015  2016", ylab="", cex.lab=.9, cex.main=.8, main="Percent usable stream length", adj=0, line=.5, col.lab="white", col.main = "white", cex.axis=0.7, col.axis="white", bg="black", yaxp=c(0,100,2), xaxp=c(2011,2016,2)),
...
setwd(paste0(otherOutPath, "/graphics/"))
  ...
  system('"C:/Program Files/ImageMagick-7.0.1-Q16/convert.exe" -delay 15 -morph 3 *.png Aso_Chinook_20.mpeg')
```
...
```{r}
    ...
    legend(x=grconvertX(c(0.80, 0.99), from='npc'),
      ...
      title(paste0("Available Chinook holding and spawning habitat in the ", nameBasin,", 10 June - 15 Oct, 2011-2016"), line=-0.1, adj=.80, col.main="black", col.sub="black", outer=FALSE, cex.main=0.6, cex.sub=0.5)
      ...
      mtext(paste0(yearPath),side =1, outer=TRUE, line=-3, col="black", cex=.75)
       ...
       tmp2 <- subplot(
        plot(sequ[1:i], dispPerc[1:i], type="l", col="blue", bty="n", ylim=c(0,100), xlim=c(1,96), xlab="2011  2012  2013  2014  2015  2016", ylab="", cex.lab=.8, cex.main=.8, main="Percent usable stream length", adj=0, line=.5, col.lab="black", col.main = "black", cex.axis=0.6, col.axis="black", bg="white", yaxp=c(0,100,2), xaxp=c(2011,2016,2)),
