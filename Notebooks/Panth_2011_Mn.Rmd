---
title: "Mid Salmon/Panther Creek Mean 2011"
...
```{r}
  mod2 <- lm(y ~ x + I(x^2) + z + e, data=data.sp[-c(88), ])
```
recheck assumptions
```{r}
  gvmodel <- gvlma(mod2)
...
setwd(paste0(modelPath, "/graphics/"))
  ...
  system('"C:/Program Files/ImageMagick-7.0.1-Q16/convert.exe" -delay 20 -morph 3 *.png Panther_2011_8D_mn.mpeg')
```
