---
title: "Upper Grande Ronde 2013 Min"
...
rerun w/o outliers
```{r}
  mod <- lm(y ~ x + I(x^2) + z + e + d + d*z, data=data.sp[-c(1520,1504,1519,1522,1330,1488,1116,1389,1517,1492,1147), ])
```
...
```{r}
  data.sp <- data.sp[-c(1520,1504,1519,1522,1330,1488,1116,1389,1517,1492,1147), ]
  y <- data.sp$y
  x <- data.sp$x
  z <- data.sp$z
  e <- data.sp$e
...
setwd(paste0(modelPath, "/graphics/"))
  ...
  system('"C:/Program Files/ImageMagick-7.0.1-Q16/convert.exe" -delay 20 -morph 3 *.png UGR_2013_8D_Min.mpeg')
```
