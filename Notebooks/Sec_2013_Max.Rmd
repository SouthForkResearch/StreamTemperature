...
```{r}
  mod <- lm(y ~ x + I(x^2) + z + e + d + d*z, data=data.fall[-c(8,11), ])
```
recheck for outliers
```{r}
  outlierTest(mod)
  ...
  for (i in 3:48)
    {
      ...
      legend("topleft", fill =  c("#0024E3","#0087CD","#16F45A","#73FF1A","#FFE200","#FFB700","#FF6A00","#FF1D00","#D00000","#AA0000"), title="°C", legend = c("0-2","2-4","4-6","6-8","8-10","10-12","12-14","14-16","16-18","18+"), bty = "n", cex=.5, inset=c(.05,0.1), text.col="white");
...
setwd(paste0(modelPath, "/graphics/"))
  ...
  system('"C:/Program Files/ImageMagick-7.0.1-Q16/convert.exe" -delay 20 -morph 3 *.png Sec_2013_8D_Mx.mpeg')
```
