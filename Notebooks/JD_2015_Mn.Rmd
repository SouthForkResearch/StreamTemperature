...
rerun w/o outliers
```{r}
  mod2 <- lm(y ~ x + I(x^2) + z + e, data=data.sp[-c(581), ])
```
...
setwd(paste0(modelPath, "/graphics/"))
  ...
  system('"C:/Program Files/ImageMagick-7.0.1-Q16/convert.exe" -delay 20 -morph 3 *.png JD_2015_8D_mn.mpeg')
```
