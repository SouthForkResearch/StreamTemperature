...
rerun w/o outliers
```{r}
  mod <- lm(y ~ x + I(x^2) + e + d, data=data.sp[-c(2199), ])
```
...
setwd(paste0(modelPath, "/graphics/"))
  ...
  system('"C:/Program Files/ImageMagick-7.0.1-Q16/convert.exe" -delay 20 -morph 3 *.png Lochsa_2011_8D_Mx.mpeg')
```
