---
title: "South Fork Salmon 2013 Min"
...
rerun w/o outliers
```{r}
  mod <- lm(y ~ x + I(x^2) + z + e + d + d*z, data=data.sp[-c(361,362,381,399,400,448,465,470), ])
```
...
```{r}
  data.sp <- data.sp[-c(361,362,381,399,400,448,465,470), ]
  y <- data.sp$y
  x <- data.sp$x
  z <- data.sp$z
  e <- data.sp$e
...
setwd(paste0(modelPath, "/graphics/"))
  i
  system('"C:/Program Files/ImageMagick-7.0.1-Q16/convert.exe" -delay 20 -morph 3 *.png SFS_2013_8D_Min.mpeg')
```
