...
```{r}
  ...
  metricPath <- "D:/OneDrive/work/research/CHaMP/CHaMP_data/Feather/2017/metrics"
...
```{r}
  ...
  write.dbf(CLST.out, file = paste0("D:/OneDrive/work/research/CHaMP/CHaMP_data/Feather/2017/LST17_FR_interp.dbf"))
  
  
```
This part calculates the zonal mean of the daily LST for each RCA
```{r}
out_Preds <- read.dbf("D:/OneDrive/work/research/CHaMP/CHaMP_data/Feather/2017/LST17_FR_interp.dbf")
...
```{r}
  ...
  plot(1:46, rca_zonal[100,1:46])
    write.dbf(rca_zonal, file = paste0("D:/OneDrive/work/research/CHaMP/CHaMP_data/Feather/2017/LST17_FR_RCA.dbf"))
  
```
Discharge data formatting
```{r}

  Dv.in <- read.csv("D:/OneDrive/work/research/CHaMP/CHaMP_Data/Feather/2017/FR_dv_data_2017.csv", stringsAsFactors = FALSE)
...
write.csv(Dv.8Day.out, paste0("D:/OneDrive/work/research/CHaMP/CHaMP_data/Feather/2017/FR_2017_Dv_8Day", ".csv"), row.names = FALSE)
...
```{r}
  Log.in <- read.csv("D:/OneDrive/work/research/CHaMP/CHaMP_data/Feather/2017/FR_logger_8D_2017_tribs.csv", stringsAsFactors = FALSE)
 

  ID.in <- read.csv("D:/OneDrive/work/research/CHaMP/GIS/coverages/Feather_River/FR_sites_rca_2017_tribs.csv", stringsAsFactors = FALSE) 
  
  LST.in <- read.dbf(paste0("D:/OneDrive/work/research/CHaMP/CHaMP_data/Feather/2017/LST17_FR_RCA.dbf"))
  colnames(LST.in)<-gsub("X", "", colnames(LST.in))
  newnamesnum <- as.numeric(colnames(LST.in)[1:46]);
  Dv.in <- read.csv("D:/OneDrive/work/research/CHaMP/CHaMP_data/Feather/2017/FR_2017_Dv_8Day.csv", stringsAsFactors = FALSE)
...
```{r}    
  coeffs_out <- data.frame(Int=numeric(2), bLST=numeric(2), bLST2=numeric(2), bJul=numeric(2), bElev=numeric(2), bzE=numeric(2))
...
```{r}
  ...
  Log.in <- read.csv(paste0("D:/OneDrive/work/research/CHaMP/CHaMP_data/Feather/2017/FR_logger_8D_2017_tribs.csv"), stringsAsFactors = FALSE)
  
  ID.in <- read.csv(paste0("D:/OneDrive/work/research/CHaMP/GIS/coverages/Feather_River/FR_sites_rca_2017_tribs.csv"), stringsAsFactors = FALSE) 
...
```{r}
  ...
  ptsname <- paste0("TempSites_2017_tribs")
...
setwd(paste0(modelPath, "/graphics/"))
  ...
  system('"C:/Program Files/ImageMagick-7.0.1-Q16/convert.exe" -delay 20 -morph 3 *.png FR_2017_8D_Mn.mpeg')
```
