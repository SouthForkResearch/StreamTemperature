...
```{r}
 rcaName <- paste0(basin, "_CHNK_net")
...
```{r}
  for (i in 61:72) #July 1-Sept 30 2011 1:12, 2012 13:24, 2013 25:36, 2014 37:48, 2015 49:60, 2016 61:72  #25:36 
    ...
    legend(x=grconvertX(c(0.84, 0.99), from='npc'),
             y=grconvertY(c(0.35, 0.44), from='npc'), fill = c("#0000CD", "#C1CDCD"), title="8-day mean max", legend = c("< 18 °C", "> 18 °C"), bty = "n", cex=.5, inset=c(.1,0), text.col="white");
      ...
      #change xlim
       tmp2 <- subplot(
        plot(sequ[1:i], dispPerc[1:i], type="l", col="lightblue", bty="n", ylim=c(0,100), xlim=c(1,72), xlab="   2011   2012   2013   2014   2015   2016", ylab="", cex.lab=.8, cex.main=.9, main="Percent usable stream length", adj=0, line=.5, col.lab="white", col.main = "white", cex.axis=0.6, col.axis="white", bg="black", yaxp=c(0,100,2), xaxp=c(2011,2013,2)),
        
        x=grconvertX(c(0.1,0.45), from='npc'), 
        y=grconvertY(c(0.04, 0.2), from='npc'),
...
setwd(paste0(otherOutPath, "/graphics/"))
  ...
  system('"C:/Program Files/ImageMagick-7.0.1-Q16/convert.exe" -delay 15 -morph 3 *.png Tuc_Chinook_18.mpeg')
```
...
```{r}
    ...
    legend(x=grconvertX(c(0.84, 0.99), from='npc'),
             y=grconvertY(c(0.35, 0.44), from='npc'), fill = c("#0000CD", "#C1CDCD"), title="8-day mean max", legend = c("< 18 °C", "> 18 °C"), bty = "n", cex=.5, inset=c(.1,0), text.col="black");
      ...
      mtext(paste0(yearPath),side =1, outer=TRUE, line=-3, col="black", cex=.75)
       ...
       tmp2 <- subplot(
        plot(sequ[1:i], dispPerc[1:i], type="l", col="blue", bty="n", ylim=c(0,100), xlim=c(1,72), xlab="2011   2012   2013   2014   2015   2016", ylab="", cex.lab=.85, cex.main=.9, main="Percent usable stream length", adj=0, line=.5, col.lab="black", col.main = "black", cex.axis=0.6, col.axis="black", bg="white", yaxp=c(0,100,2), xaxp=c(2011,2016,2)),
