...
```{r}
  for (i in 81:96) #June 10-Oct 15 2011 1:16, 2012 17:32, 2013 33:48, 2014 49:64, 2015 65:80, 2016 81:96  #21:36 
    ...
    legend(x=grconvertX(c(0.84, 0.99), from='npc'),
             y=grconvertY(c(0.35, 0.44), from='npc'), fill = c("#0000CD", "#C1CDCD"), title="8-day mean max", legend = c("< 20 °C", "> 20 °C"), bty = "n", cex=.5, inset=c(.1,0), text.col="white");
...
setwd(paste0(otherOutPath, "/graphics/"))
  ...
  system('"C:/Program Files/ImageMagick-7.0.1-Q16/convert.exe" -delay 15 -morph 3 *.png Tuc_Chinook_20.mpeg')
```
...
```{r}
    ...
    legend(x=grconvertX(c(0.84, 0.99), from='npc'),
             y=grconvertY(c(0.35, 0.44), from='npc'), fill = c("#0000CD", "#C1CDCD"), title="8-day mean max", legend = c("< 20 °C", "> 20 °C"), bty = "n", cex=.5, inset=c(.1,0), text.col="black");
