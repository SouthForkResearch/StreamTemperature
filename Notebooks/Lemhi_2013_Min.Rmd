...
Model building
```{r}
  Log.in <- read.csv(paste0(basin, "_", yearPath, "_all_logger_8Day_", var, ".csv"), stringsAsFactors = FALSE)
  Log.in <- Log.in[,c(1,2,4,8,9)]

  ID.in <- read.csv(paste0("../../", longBasin, "_sites_rca_elev.csv"), stringsAsFactors=FALSE)
  colnames(ID.in)[5] <- "SiteID"
...
setwd(paste0(modelPath, "/graphics/"))
  ...
  system('"C:/Program Files/ImageMagick-7.0.1-Q16/convert.exe" -delay 20 -morph 3 *.png Lemhi_2013_8D_Min.mpeg')
```
