...
rerun w/o outliers
```{r}
  mod <- lm(y ~ x + I(x^2) + e + d, data=NoNA.xyz[-c(##), ])
```
...
setwd(paste0(modelPath, "/graphics/"))
  ...
  system('"C:/Program Files/ImageMagick-7.0.1-Q16/convert.exe" -delay 20 -morph 3 *.png Sec_2011_8D_Min.mpeg')
```
