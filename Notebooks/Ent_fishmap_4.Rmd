...
```{r}
 rcaName <- paste0(basin, "_STHD_net")
   ...
   rcas <- subset(rcas, STHD_IP == "Steelhead") 
  #  rcas <- as.matrix(rcas)
...
setwd(paste0(otherOutPath, "/graphics/"))
  ...
  system('"C:/Program Files/ImageMagick-7.0.1-Q16/convert.exe" -delay 15 -morph 3 *.png Ent_STHD_4.mpeg')
```
...
```{r}
  ...
  plot(sequ[1:j], dispPerc[1:j], type="l", col="lightblue", bty="n", ylim=c(0,110), xlim=c(1,102),
       ...
       main=paste0("Steelhead spawning habitat in the ", nameBasin, " under ", temp, " °C, 2011-2016 \n \n Percent usable stream length"), adj=0, line=0.1, col.lab="black", col.main = "black", 
