---
title: "Siletz Watershed 2016 Mean"
...
```{r}
  ...
  nameBasin <- "Siletz" #this is from the Projects XML list of approved names
  
  
  mainPath <- "D:/OneDrive/work/research/CHaMP/CHaMP_data/"
  metricPath <- "D:/OneDrive/work/research/CHaMP/CHaMP_data/Siletz/2016/metrics"
...
```{r, message=FALSE}
  ...
  LST.in <- read.csv("D:/OneDrive/work/research/CHaMP/GIS/coverages/Siletz/Siletz_LST_2016_only2.csv")
  PointID <- LST.in[,1]
  LST.in <- LST.in[,2:47]
...
```{r}
  ...
  write.dbf(CLST.out, file = paste0("D:/OneDrive/work/research/CHaMP/CHaMP_data/Siletz/2016/LST16_SL_interp.dbf"))
  
  
```
This part calculates the zonal mean of the daily LST for each RCA
```{r}
out_Preds <- read.dbf("D:/OneDrive/work/research/CHaMP/CHaMP_data/Siletz/2016/LST16_SL_interp.dbf")
  
  
  weights <- read.csv("D:/OneDrive/work/research/CHaMP/CHaMP_data/Siletz/SL_rca_area_wgts_a.csv")
...
```{r}
  ...
  plot(1:46, rca_zonal[100,1:46])
    write.dbf(rca_zonal, file = paste0("D:/OneDrive/work/research/CHaMP/CHaMP_data/Siletz/2016/LST16_SL_RCA.dbf"))
  
```
Discharge data formatting
```{r}

  Dv.in <- read.csv("D:/OneDrive/work/research/CHaMP/CHaMP_data/Siletz/2016/SL_dv_data_2016.csv", stringsAsFactors = FALSE)
...
write.csv(Dv.8Day.out, paste0("D:/OneDrive/work/research/CHaMP/CHaMP_data/Siletz/2016/SL_2016_Dv_8Day", ".csv"), row.names = FALSE)
...
```{r}
  Log.in <- read.csv("D:/OneDrive/work/research/CHaMP/CHaMP_data/Siletz/2016/SL_logger_8D_2016_SLonly2_noDEQ.csv", stringsAsFactors = FALSE)
 

  ID.in <- read.csv("D:/OneDrive/work/research/CHaMP/GIS/coverages/Siletz/SL_sites_rca_2016_noDEQ.csv", stringsAsFactors = FALSE) 
  
  LST.in <- read.dbf(paste0("D:/OneDrive/work/research/CHaMP/CHaMP_data/Siletz/2016/LST16_SL_RCA.dbf"))
  colnames(LST.in)<-gsub("X", "", colnames(LST.in))
  newnamesnum <- as.numeric(colnames(LST.in)[1:46]);
  Dv.in <- read.csv("D:/OneDrive/work/research/CHaMP/CHaMP_data/Siletz/2016/SL_2016_Dv_8Day.csv", stringsAsFactors = FALSE)
...
```{r}
  ...
  elev.in <- read.csv(paste0("D:/OneDrive/work/research/CHaMP/CHaMP_data/Siletz/SL_rca_elev.csv"), stringsAsFactors = F)
...
```{r}
  ...
  Log.in <- read.csv(paste0("D:/OneDrive/work/research/CHaMP/CHaMP_data/Siletz/2016/SL_logger_8D_2016_SLonly.csv"), stringsAsFactors = FALSE)
  
  ID.in <- read.csv(paste0("D:/OneDrive/work/research/CHaMP/GIS/coverages/Siletz/SL_sites_rca_2016.csv"), stringsAsFactors = FALSE) 
...
```{r}
  ...
  netname <- paste0("Siletz_only_NSI_2016")
  ptsname <- paste0("SL_TempSite_2016_SLonly_noDEQ_b")
...
setwd(paste0(modelPath, "/graphics/"))
  ...
  system('"C:/Program Files/ImageMagick-7.0.1-Q16/convert.exe" -delay 20 -morph 3 *.png SL_2016_8D_Mn.mpeg')
```
