...
```{r}
  ...
  var <- "Min"
  longVar <- "Min"
  dataVar <- "Min8DayAvg" #name of the variable in the logger data
  capVar <- "MIN"
...
```{r}
  ...
  LST.in <- read.csv(paste0("../../", "LST", yrPath, "_", basin, "_RCA.csv"), stringsAsFactors = FALSE)
  ...
  for (i in 3:48)
    {
      ...
      points(error_pts, pch=16, col="gray40", cex=cexEr)
       ...
       legend("right", fill = attr(fix3.colors, "palette"), title=paste0("8-day ", var, " (°C)"),legend = c("0-6","6-8","8-10","10-12","12-14","14-16","16-18","18-20", "20-22", "22+"), bty = "n", cex=.5, inset=c(0,0), text.col="white");
...
setwd(paste0(modelPath, "/graphics/"))
  ...
  system('"C:/Program Files/ImageMagick-7.0.1-Q16/convert.exe" -delay 20 -morph 3 *.png Wen_2011_8D_Min.mpeg')
```
