---
title: "North Fork John Day 2011 Min"
  ...
  for (i in 3:48)
    {
      ...
      tmp2 <- subplot(
        ...
        x=grconvertX(c(0.60,0.90), from='npc'), 
...
setwd(paste0(modelPath, "/graphics/"))
  ...
  system('"C:/Program Files/ImageMagick-7.0.1-Q16/convert.exe" -delay 20 -morph 3 *.png NFJD_2011_8D_Min.mpeg')
```
