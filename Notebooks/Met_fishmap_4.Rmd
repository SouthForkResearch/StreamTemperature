...
```{r}
  for (i in 86:102) # 2011 1:17, 2012 18:34, 2013 35:51, 2014 52:68, 2015 69:85, 2016 86:102;   7-23 
    ...
    legend(x=grconvertX(c(0.46, 0.59), from='npc'),
      ...
      #change xlim
       tmp2 <- subplot(
        plot(sequ[1:i], dispPerc[1:i], type="l", col="lightblue", bty="n", ylim=c(0,100), xlim=c(1,102), xlab="  2011  2012  2013  2014  2015  2016", ylab="", cex.lab=.9, cex.main=.8, main="Percent usable stream length", adj=0, line=.5, col.lab="white", col.main = "white", cex.axis=0.6, col.axis="white", bg="black", yaxp=c(0,100,2), xaxp=c(2011,2016,2)),
        
        x=grconvertX(c(0.02,0.45), from='npc'), 
        y=grconvertY(c(0.02, 0.20), from='npc'),
        size=c(1,1.5), vadj=0.5, hadj=0.5, 
        pars=list( mar=c(0,0,0,0)+0.1, cex=0.6))
...
setwd(paste0(otherOutPath, "/graphics/"))
  ...
  system('"C:/Program Files/ImageMagick-7.0.1-Q16/convert.exe" -delay 15 -morph 3 *.png Met_STHD_4.mpeg')
```
...
```{r}
    ...
    legend(x=grconvertX(c(0.80,0.99), from='npc'), 
      ...
      mtext(paste0(yearPath),side =1, outer=TRUE, line=-3, col="black", cex=.75)
       ...
       tmp2 <- subplot(
        plot(sequ[1:i], dispPerc[1:i], type="l", col="lightblue", bty="n", ylim=c(0,100), xlim=c(1,102), xlab="2011  2012  2013  2014  2015  2016", ylab="", cex.lab=.9, cex.main=.8, main="Percent usable stream length", adj=0, line=.5, col.lab="black", col.main = "black", cex.axis=0.6, col.axis="black", bg="white", yaxp=c(0,100,2), xaxp=c(2011,2016,2)),
        
        x=grconvertX(c(0.0,0.45), from='npc'), 
