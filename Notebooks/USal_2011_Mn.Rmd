...
```{r}
  ...
  ID.in <- read.csv(paste0("../../", basin, "/", basin, "_sites_rca_elev.csv"), stringsAsFactors = FALSE) 
...
```{r}
  ...
  filename <- paste0(modelPath, "/graphics/", basin, "_", yearPath, "_8D_", var, ".png", sep="")
