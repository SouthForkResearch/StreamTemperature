---
title: "South Fork Salmon 2015 Mean"
...
```{r}  
  ...
  points(namesnum, LogPred.out[8005, 1:46], pch=16, col="lightblue")}
...
setwd(paste0(modelPath, "/graphics/"))
  ...
  system('"C:/Program Files/ImageMagick-7.0.1-Q16/convert.exe" -delay 20 -morph 3 *.png SFS_2015_8D_Mn.mpeg')
```
