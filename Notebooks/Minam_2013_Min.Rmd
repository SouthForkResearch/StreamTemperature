...
```{r}
  ...
  var <- "Min"
  longVar <- "Min"
  dataVar <- "X8DayMin" #name of the variable in the logger data
  capVar <- "MIN"
...
setwd(paste0(modelPath, "/graphics/"))
  ...
  system('"C:/Program Files/ImageMagick-7.0.1-Q16/convert.exe" -delay 20 -morph 3 *.png Minam_2013_8D_Min.mpeg')
```
