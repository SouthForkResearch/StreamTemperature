...
```{r}
  ...
  ID.in <- read.csv(paste0(mainPath, "/",longBasin,"/", basin, "_sites_rca.csv"), stringsAsFactors = FALSE) 
...
setwd(paste0(modelPath, "/graphics/"))
  ...
  system('"C:/Program Files/ImageMagick-7.0.1-Q16/convert.exe" -delay 20 -morph 3 *.png Met_2011_8D_Mx.mpeg')
```
