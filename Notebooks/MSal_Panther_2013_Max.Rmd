---
title: "Mid Salmon / Panther Creek Max 2013"
...
setwd(paste0(modelPath, "/graphics/"))
  ...
  system('"C:/Program Files/ImageMagick-7.0.1-Q16/convert.exe" -delay 20 -morph 3 *.png Panther_2013_8D_Mx.mpeg')
```
...
```{r}
  ...
  filename <- paste0(modelPath, "/graphics/Stills
                     ", basin, "_", yearPath, "_8D_", var, ".png", sep="")
