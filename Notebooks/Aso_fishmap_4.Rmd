...
```{r}
  for (i in 86:102) # 2011 1:17, 2012 18:34, 2013 35:51, 2014 52:68, 2015 69:85, 2016 86:102;   7-23 
    ...
    legend(x=grconvertX(c(0.80,0.95), from='npc'), 
    ...
    legend(x=grconvertX(c(0.54, 0.69), from='npc'),
      ...
      #change xlim
       ...
       tmp2 <- subplot(
        plot(sequ[1:i], dispPerc2[1:i], type="l", col="cyan2", bty="n", ylim=c(0,100), xlim=c(1,102), xlab="", ylab="", cex.lab=.8, cex.main=.8, main="", adj=0, line=.5, col.lab="white", col.main = "white", cex.axis=0.6, col.axis="white", bg="black", yaxp=c(0,100,2), xaxp=c(2011,2016,2)),
...
setwd(paste0(otherOutPath, "/graphics/"))
  ...
  system('"C:/Program Files/ImageMagick-7.0.1-Q16/convert.exe" -delay 15 -morph 3 *.png Aso_STHD_4.mpeg')
```
...
```{r}
    ...
    par(oma=c(0,0,0,0))
      ...
      mtext(paste0(yearPath),side =1, outer=TRUE, line=-3, col="black", cex=.75)
       ...
       tmp2 <- subplot(
        plot(sequ[1:i], dispPerc2[1:i], type="l", col="cyan2", bty="n", ylim=c(0,100), xlim=c(1,102), xlab="", ylab="", cex.lab=.8, cex.main=.8, main="", adj=0, line=.5, col.lab="black", col.main = "black", cex.axis=0.6, col.axis="black", bg="white", yaxp=c(0,100,2), xaxp=c(2011,2016,2)),
