...
```{r}
  ...
  NoNA.xyz <- NoNA.xyz[,c("Avg8DayAvg", "LST", "JulDay", "Elev", "SiteName")]
...
```{r}
  ...
  LST.in <- read.csv(paste0(mainPath, longBasin, "/", "LST", yrPath, "_", basin, "_RCA.cav"), stringsAsFactors = FALSE)
...
```{r, message=FALSE}
  ...
  NoNA.pred <- NoNA.pred[,c(14, 2, 1, 6)]
...
setwd(paste0(modelPath, "/graphics/"))
  ...
  system('"C:/Program Files/ImageMagick-7.0.1-Q16/convert.exe" -delay 20 -morph 3 *.png Wen_2014_8D_Max.mpeg')
```
