---
title: "Yankee Fork RV modeling - Max temp"
...
```{r}
  ...
  gisPath <- "D:/OneDrive/work/research/CHaMP/GIS/coverages/Yankee_Fork"
...
write it out
```{r}
  write.table(x=AlldataOut, append=F,row.names=F, file = paste0("13_15/", longVar, "/", basin, "_13-15_pot_Max_temp.csv"), sep = ",", col.names=T)
