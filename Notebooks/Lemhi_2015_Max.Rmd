...
```{r, message=FALSE}
  ...
  ptsname <- paste0(basin, "_all_sites_RCA")
  
  error_pts <- readOGR(dsn=gisPath, ptsname)
  error_pts@data <- error_pts@data[,c(5,10)]
...
setwd(paste0(modelPath, "/graphics/"))
  ...
  system('"C:/Program Files/ImageMagick-7.0.1-Q16/convert.exe" -delay 20 -morph 3 *.png Lemhi_2015_8D_Min.mpeg')
```
