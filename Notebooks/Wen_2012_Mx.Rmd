...
library(uuid)
  ...
  var <- "Mx"
  longVar <- "Max"
  dataVar <- "X8DayMx" #name of the variable in the logger data
  capVar <- "MAX"
...
rerun w/o outliers
```{r}
  mod <- lm(y ~ x + I(x^2) + z + e, data=data.sp[-c(291,302), ])
```
...
setwd(paste0(modelPath, "/graphics/"))
  ...
  system('"C:/Program Files/ImageMagick-7.0.1-Q16/convert.exe" -delay 20 -morph 3 *.png Wen_2012_8D_Max.mpeg')
```
