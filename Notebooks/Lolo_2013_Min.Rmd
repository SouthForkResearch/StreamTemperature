...
```{r}
  ...
  nameBasin <- "Lolo" #this is from the Projects XML list of approved names
...
```{r}
  ...
  points(newnamesnum, LogPred.out[130, 1:46], pch=16, col="blue")
...
setwd(paste0(modelPath, "/graphics/"))
  ...
  system('"C:/Program Files/ImageMagick-7.0.1-Q16/convert.exe" -delay 20 -morph 3 *.png Lolo_2013_8D_Min.mpeg')
```
...
```{r}
  ...
  filename <- paste0(modelPath, "/graphics/Stills/", basin, "_", yearPath, "_8D_", var, ".png", sep="")
    ...
    legend(x=grconvertX(c(0.89, 0.99), from='npc'), 
             y=grconvertY(c(0.30, 0.55), from='npc'), fill = attr(fix3.colors, "palette"), title="°C", legend = c("0-2","2-4","4-6","6-8","8-10","10-12","12-14","14-16","16-18","18+"), bty = "n", cex=.5, inset=c(.1,0), text.col="black");
      legend(x=grconvertX(c(0.0, 0.20), from='npc'), 
