---
title: "Yankee Fork RV modeling - Mean temp"
...
```{r}
  ...
  #LST.in <- read.csv(paste0(mainPath, "/", "LST", yrPath, "_", basin, "_RCA.csv"), stringsAsFactors = FALSE)
...
write it out
```{r}
  write.table(x=AlldataOut, append=F,row.names=F, file = paste0("13_15/", longVar, "/", basin, "_13-15_pot_Mn_temp.csv"), sep = ",", col.names=T)
  ...
  write.csv(outputStats, file = paste0("13_15/", longVar, "/", basin, "_13-15_mean_Diff.csv"), row.names=FALSE)
```
