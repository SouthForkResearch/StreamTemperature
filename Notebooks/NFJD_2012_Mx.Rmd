---
title: "North Fork John Day 2012 Max"
  ...
  for (i in 3:48)
    {
      ...
      legend( x=grconvertX(c(0.90,0.99), from='npc'), 
        ...
        fill = attr(fix3.colors, "palette"), title="°C", legend = c("0-4","4-6","6-8","8-10","10-12","12-14","14-16","16-18","18-20","20-22"), bty = "n", cex=.5, inset=c(.05,0.1), text.col="white");
...
setwd(paste0(modelPath, "/graphics/"))
  ...
  system('"C:/Program Files/ImageMagick-7.0.1-Q16/convert.exe" -delay 20 -morph 3 *.png NFJD_2012_8D_Max.mpeg')
```
