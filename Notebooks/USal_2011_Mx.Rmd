...
```{r}
  ...
  for (i in 3:48)
    ...
    legend(x=grconvertX(c(0.8, 0.9), from='npc'), 
      ...
      title(paste0(nameBasin, " 8-day ", longVar, " ", yearPath, " (°C)"), line=-0.1, adj=0.7, col.main="white", col.sub="white", outer=FALSE, cex.main=0.5, cex.sub=0.5)
...
setwd(paste0(graphicsPath))
  ...
  system('"C:/Program Files/ImageMagick-7.0.1-Q16/convert.exe" -delay 20 -morph 3 *.png USal_2011_8D_MX.mpeg')
```
