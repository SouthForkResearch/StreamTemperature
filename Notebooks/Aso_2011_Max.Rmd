...
rerun w/o outliers
```{r}
  mod <- lm(y ~ x + I(x^2) + z + e + d, data=data.sp[-c(167), ])
```
  ...
  for (i in 3:48)
    {
      ...
      filename <- paste0(mainPath, longBasin, "/", yearPath, "/", longVar, "/graphics/", namer[i-2], ".png", sep="")
...
setwd(paste0(modelPath, "/graphics/"))
  ...
  system('"C:/Program Files/ImageMagick-7.0.1-Q16/convert.exe" -delay 20 -morph 3 *.png Asotin_2011_8D_Max.mpeg')
```
