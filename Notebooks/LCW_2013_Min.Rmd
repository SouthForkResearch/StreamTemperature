---
title: "Lower Clearwater Min 2013"
...
rerun w/o outliers
```{r}
  mod <- lm(y ~ x + I(x^2) + z + e + d, data=data.sp[-c(962, 959, 1344, 1286, 1283), ])
```
...
```{r}
  data.sp <- data.sp[-c(962, 959, 1344, 1286, 1283), ]
  y <- data.sp$y
  x <- data.sp$x
  z <- data.sp$z
  e <- data.sp$e
...
setwd(paste0(modelPath, "/graphics/"))
  ...
  system('"C:/Program Files/ImageMagick-7.0.1-Q16/convert.exe" -delay 20 -morph 3 *.png LCW_2013_8D_Min.mpeg')
```
