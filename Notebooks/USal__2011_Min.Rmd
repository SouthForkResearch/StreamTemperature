...
rerun w/o outliers
```{r}
  mod <- lm(y ~ x + I(x^2) + z + e + d, data=data.sp[-c(335,296,307,309,353,355,399,401,381,447,427,285,445,274,263), ])
```
...
```{r}
  data.sp <- data.sp[-c(335,296,307,309,353,355,399,401,381,447,427,285,445,274,263), ]
  y <- data.sp$y
  x <- data.sp$x
  z <- data.sp$z
  e <- data.sp$e
...
setwd(paste0(modelPath, "/graphics/"))
  ...
  system('"C:/Program Files/ImageMagick-7.0.1-Q16/convert.exe" -delay 20 -morph 3 *.png USal_2011_8D_Min.mpeg')
```
