...
rerun w/o outliers
```{r}
  mod <- lm(y ~ x + I(x^2) + z + e + d1 + d2, data=data.sp[-c(1703,1776,1630,1627), ])
```
...
```{r}
  data.sp <- data.sp[-c(1703,1776,1630,1627), ]
  y <- data.sp$y
  x <- data.sp$x
  z <- data.sp$z
  e <- data.sp$e
...
setwd(paste0(modelPath, "/graphics/"))
  ...
  system('"C:/Program Files/ImageMagick-7.0.1-Q16/convert.exe" -delay 20 -morph 3 *.png LCW_2011_8D_Min.mpeg')
```
