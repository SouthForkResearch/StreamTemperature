...
```{r}
  for (i in 61:72) #July 1-Sept 30 2011 1:12, 2012 13:24, 2013 25:36, 2014 37:48, 2015 49:60, 2016 61:72  #25:36 
    ...
    legend(x=grconvertX(c(0.80, 0.99), from='npc'),
      ...
      #change xlim
       tmp2 <- subplot(
        ...
        x=grconvertX(c(0.70,0.99), from='npc'), 
        y=grconvertY(c(0.00,0.20), from='npc'),
...
setwd(paste0(otherOutPath, "/graphics/"))
  ...
  system('"C:/Program Files/ImageMagick-7.0.1-Q16/convert.exe" -delay 15 -morph 3 *.png Aso_Chinook_18.mpeg')
```
