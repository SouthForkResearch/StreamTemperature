...
```{r}
 rcaName <- paste0(basin, "_IP_RCAID")
...
setwd(paste0(otherOutPath, "/graphics/"))
  ...
  system('"C:/Program Files/ImageMagick-7.0.1-Q16/convert.exe" -delay 15 -morph 3 *.png Lem_Chinook_18.mpeg')
```
...
```{r}
    ...
    legend(x=grconvertX(c(0.78, 0.95), from='npc'),
      ...
      mtext(paste0(yearPath),side =1, outer=TRUE, line=-3, col="black", cex=.75)
       ...
       tmp2 <- subplot(
        plot(sequ[1:i], dispPerc[1:i], type="l", col="blue", bty="n", ylim=c(0,100), xlim=c(1,72), xlab="     2011    2012    2013    2014    2015    2016", ylab="", cex.lab=.8, cex.main=.9, main="Percent usable stream length", adj=0, line=.5, col.lab="black", col.main = "black", cex.axis=0.6, col.axis="black", bg="white", yaxp=c(0,100,2), xaxp=c(2011,2016,2)),
...
```{r}
    ...
    j <- 72 #change for different years 
  ...
  plot(sequ[1:j], dispPerc[1:j], type="l", col="blue", bty="n", ylim=c(0,110), xlim=c(1,72),
       ...
       xlab="     2011    2012    2013    2014    2015    2016", ylab="", cex.lab=.6, cex.main=.4, 
