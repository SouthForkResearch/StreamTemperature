...
# #####################
  ...
  list <- mget(paste0("Ppt_Wen_", 2000:2015))
  ...
  points(Ppt_Wen_2005[3:367], pch=16, col="darkgrey", cex=.7)
  points(Ppt_Wen_2006[3:367], pch=16, col="lightblue", cex=.7)
  points(Ppt_Wen_2007[3:367], pch=16, col="red", cex=.7)
  points(Ppt_Wen_2008[3:367], pch=16, col="palevioletred", cex=.7)
  points(Ppt_Wen_2009[3:367], pch=16, col="darkgoldenrod1", cex=.7)
  points(Ppt_Wen_2010[3:367], pch=16, col="blueviolet", cex=.7)
  points(Ppt_Wen_2011[3:367], pch=16, col="lightgrey", cex=.7)
  ...
  points(Ppt_Wen_2015[3:367], pch=16, col="blue2", cex=.7)
...
##### plots #####
  ...
  points(Tmp_Wen_2005[3:367], pch=16, col="darkgrey", cex=.7)
  points(Tmp_Wen_2006[3:367], pch=16, col="lightblue", cex=.7)
  points(Tmp_Wen_2007[3:367], pch=16, col="red", cex=.7)
  points(Tmp_Wen_2008[3:367], pch=16, col="palevioletred", cex=.7)
  points(Tmp_Wen_2009[3:367], pch=16, col="darkgoldenrod1", cex=.7)
  points(Tmp_Wen_2010[3:367], pch=16, col="blueviolet", cex=.7)
  points(Tmp_Wen_2011[3:367], pch=16, col="lightgrey", cex=.7)
  ...
  points(Wen_05_mn_ppt[3:367], pch=16, col="darkgrey", cex=.7)
  points(Wen_06_mn_ppt[3:367], pch=16, col="lightblue", cex=.7)
  points(Wen_07_mn_ppt[3:367], pch=16, col="red", cex=.7)
  points(Wen_08_mn_ppt[3:367], pch=16, col="palevioletred", cex=.7)
  points(Wen_09_mn_ppt[3:367], pch=16, col="darkgoldenrod1", cex=.7)
  points(Wen_10_mn_ppt[3:367], pch=16, col="blueviolet", cex=.7)
  points(Wen_11_mn_ppt[3:367], pch=16, col="lightgrey", cex=.7)
...
##### vector of annual mean cumulative temps#####
  
  #this is the cumulative mean temperature by year
  
  list <- mget(paste0("Tmp_", basin, "_", 2000:2015))
  all <- do.call(rbind, list)
  
  y01_15_temp <- all[2:16, 367] 
  
  # this is the mean cumulative mean by year
  
  y01_15_temper <- c(mean(Tmp_Wen_2001), mean(Tmp_Wen_2002), mean(Tmp_Wen_2003), mean(Tmp_Wen_2004), mean(Tmp_Wen_2005), mean(Tmp_Wen_2006), mean(Tmp_Wen_2007), mean(Tmp_Wen_2008), mean(Tmp_Wen_2009), mean(Tmp_Wen_2010), mean(Tmp_Wen_2011), mean(Tmp_Wen_2012), mean(Tmp_Wen_2013), mean(Tmp_Wen_2014), mean(Tmp_Wen_2015))
  
  # this is the cumulative mean for each year
 
  list <- mget(paste0("Ppt_", basin, "_", 2000:2015))
  all <- do.call(rbind, list)
  ...
  y01_15_precip <- c(mean(Ppt_Wen_2001), mean(Ppt_Wen_2002), mean(Ppt_Wen_2003), mean(Ppt_Wen_2004), mean(Ppt_Wen_2005), mean(Ppt_Wen_2006), mean(Ppt_Wen_2007), mean(Ppt_Wen_2008), mean(Ppt_Wen_2009), mean(Ppt_Wen_2010), mean(Ppt_Wen_2011), mean(Ppt_Wen_2012), mean(Ppt_Wen_2013), mean(Ppt_Wen_2014), mean(Ppt_Wen_2015))

  col.rainbow <- rainbow(15)
  
  plot(y01_15_temper, y01_15_precip, pch=c(21,22,23,24, 25), col="black", bg=col.rainbow, main=paste0(basin, " mean cumulative mean temp/precip (calendar year)"), xlab = "Mean temp", ylab = "Mean precip", cex=1.5,)
...
###### 30 yr means ####   
  y35_mn_temp <- c(mean(Tmp_Wen_1981[3:367]), mean(Tmp_Wen_1982[3:367]), mean(Tmp_Wen_1983[3:367]), mean(Tmp_Wen_1984[3:367]), mean(Tmp_Wen_1985[3:367]), mean(Tmp_Wen_1986[3:367]), mean(Tmp_Wen_1987[3:367]), mean(Tmp_Wen_1988[3:367]), mean(Tmp_Wen_1989[3:367]), mean(Tmp_Wen_1990[3:367]), mean(Tmp_Wen_1991[3:367]), mean(Tmp_Wen_1992[3:367]), mean(Tmp_Wen_1993[3:367]), mean(Tmp_Wen_1994[3:367]), mean(Tmp_Wen_1995[3:367]), mean(Tmp_Wen_1996[3:367]), mean(Tmp_Wen_1997[3:367]), mean(Tmp_Wen_1998[3:367]), mean(Tmp_Wen_1999[3:367]), mean(Tmp_Wen_2000[3:367]), mean(Tmp_Wen_2001[3:367]), mean(Tmp_Wen_2002[3:367]), mean(Tmp_Wen_2003[3:367]), mean(Tmp_Wen_2004[3:367]), mean(Tmp_Wen_2005[3:367]), mean(Tmp_Wen_2006[3:367]), mean(Tmp_Wen_2007[3:367]), mean(Tmp_Wen_2008[3:367]), mean(Tmp_Wen_2009[3:367]), mean(Tmp_Wen_2010[3:367]), mean(Tmp_Wen_2011[3:367]), mean(Tmp_Wen_2012[3:367]), mean(Tmp_Wen_2013[3:367]), mean(Tmp_Wen_2014[3:367]), mean(Tmp_Wen_2015[3:367]))
  #
  y35_mn_ppt <- c(mean(Ppt_Wen_1981[3:367]), mean(Ppt_Wen_1982[3:367]), mean(Ppt_Wen_1983[3:367]), mean(Ppt_Wen_1984[3:367]), mean(Ppt_Wen_1985[3:367]), mean(Ppt_Wen_1986[3:367]), mean(Ppt_Wen_1987[3:367]), mean(Ppt_Wen_1988[3:367]), mean(Ppt_Wen_1989[3:367]), mean(Ppt_Wen_1990[3:367]), mean(Ppt_Wen_1991[3:367]), mean(Ppt_Wen_1992[3:367]), mean(Ppt_Wen_1993[3:367]), mean(Ppt_Wen_1994[3:367]), mean(Ppt_Wen_1995[3:367]), mean(Ppt_Wen_1996[3:367]), mean(Ppt_Wen_1997[3:367]), mean(Ppt_Wen_1998[3:367]), mean(Ppt_Wen_1999[3:367]), mean(Ppt_Wen_2000[3:367]), mean(Ppt_Wen_2001[3:367]), mean(Ppt_Wen_2002[3:367]), mean(Ppt_Wen_2003[3:367]), mean(Ppt_Wen_2004[3:367]), mean(Ppt_Wen_2005[3:367]), mean(Ppt_Wen_2006[3:367]), mean(Ppt_Wen_2007[3:367]), mean(Ppt_Wen_2008[3:367]), mean(Ppt_Wen_2009[3:367]), mean(Ppt_Wen_2010[3:367]), mean(Ppt_Wen_2011[3:367]), mean(Ppt_Wen_2012[3:367]), mean(Ppt_Wen_2013[3:367]), mean(Ppt_Wen_2014[3:367]), mean(Ppt_Wen_2015[3:367]))
  #
  ...
  plot(y35_mn_temp[1:30], y35_mn_ppt[1:30], pch=c(21, 22, 23, 24, 25), col="black", bg=col.rainbow, main="Mean sum temp/precip (calendar year)", xlab = "Mean temp", ylab = "Mean precip", cex=1.5, )
  ...
  legend(x=grconvertX(c(1.0,1.4), from='npc'), 
         y=grconvertY(c(0.6, 1.3), from='npc'), pch=c(20, 16,15,18,17,6), bty="n", legend = c("81", "82", "82", "84", "85", "86", "87", "88", "89", "90", "91", "92", "93", "94", "95", "96", "97", "98", "99", "00", "01", "02", "03", "04", "05", "06", "07","08","09", "10", "11", "12", "13", "14", "15"), col=col.rainbow, cex=.75, xpd=NA)

########## plot of Mean cumulative temp/precip by calendar year 2001-2015 ##########
  
  plot(y35_mn_temp[21:35], y35_mn_ppt[21:35], pch=c(21, 22, 23, 24, 25), col="black", bg=col.rainbow, main="Wen mean cumulative temp/precip (calendar year)", xlab = "Mean cumulative temp", ylab = "Mean cumulative precip", cex=1.5, )
...
##### vector of annual cumulative temp #######
  
  y35_sum_temp <- c(Tmp_Wen_1981[367], Tmp_Wen_1982[367], Tmp_Wen_1983[367], Tmp_Wen_1984[367], Tmp_Wen_1985[367], (Tmp_Wen_1986[367]), Tmp_Wen_1987[367], Tmp_Wen_1988[367], Tmp_Wen_1989[367], Tmp_Wen_1990[367], Tmp_Wen_1991[367], Tmp_Wen_1992[367], Tmp_Wen_1993[367], Tmp_Wen_1994[367], Tmp_Wen_1995[367], Tmp_Wen_1996[367], Tmp_Wen_1997[367], Tmp_Wen_1998[367], Tmp_Wen_1999[367], Tmp_Wen_2000[367], Tmp_Wen_2001[367], Tmp_Wen_2002[367], Tmp_Wen_2003[367], Tmp_Wen_2004[367], Tmp_Wen_2005[367], Tmp_Wen_2006[367], Tmp_Wen_2007[367], Tmp_Wen_2008[367], (Tmp_Wen_2009[367]), Tmp_Wen_2010[367], Tmp_Wen_2011[367], Tmp_Wen_2012[367], Tmp_Wen_2013[367], Tmp_Wen_2014[367], Tmp_Wen_2015[367])
  #
  y35_sum_precip <- c(Ppt_Wen_1981[367], Ppt_Wen_1982[367], Ppt_Wen_1983[367], Ppt_Wen_1984[367], Ppt_Wen_1985[367], (Ppt_Wen_1986[367]), Ppt_Wen_1987[367], Ppt_Wen_1988[367], Ppt_Wen_1989[367], Ppt_Wen_1990[367], Ppt_Wen_1991[367], Ppt_Wen_1992[367], Ppt_Wen_1993[367], Ppt_Wen_1994[367], Ppt_Wen_1995[367], Ppt_Wen_1996[367], Ppt_Wen_1997[367], Ppt_Wen_1998[367], Ppt_Wen_1999[367], Ppt_Wen_2000[367], Ppt_Wen_2001[367], Ppt_Wen_2002[367], Ppt_Wen_2003[367], Ppt_Wen_2004[367], Ppt_Wen_2005[367], Ppt_Wen_2006[367], Ppt_Wen_2007[367], Ppt_Wen_2008[367], (Ppt_Wen_2009[367]), Ppt_Wen_2010[367], Ppt_Wen_2011[367], Ppt_Wen_2012[367], Ppt_Wen_2013[367], Ppt_Wen_2014[367], Ppt_Wen_2015[367])
  
  names(y35_sum_temp)[1:35] <- c("81", "82", "82", "84", "85", "86", "87", "88", "89", "90", "91", "92", "93", "94", "95", "96", "97", "98", "99", "00", "01", "02", "03", "04", "05", "06", "07","08","09", "10", "11", "12", "13", "14", "15")
  names(y35_sum_precip)[1:35] <- c("81", "82", "82", "84", "85", "86", "87", "88", "89", "90", "91", "92", "93", "94", "95", "96", "97", "98", "99", "00", "01", "02", "03", "04", "05", "06", "07","08","09", "10", "11", "12", "13", "14", "15")
  
  names = c("00", "01", "02", "03", "04", "05", "06", "07","08","09", "10", "11", "12", "13", "14", "15")
  
  col.rainbow <- rainbow(15)
  
  plot(y35_sum_temp[20:35], y35_sum_precip[20:35], pch=c(15,16,17), col=col.rainbow, main="Mean sum temp/precip (calendar year)", xlab = "Mean temp", ylab = "Mean precip", cex=1.5, )
  points(y30_mn_temp, y30_mn_precip, pch=8, cex=1.4)
  legend(x=grconvertX(c(1.0,1.4), from='npc'), 
         y=grconvertY(c(0.1, 1.2), from='npc'), pch=c(15,16,17), bty="n", legend = c("00", "01", "02", "03", "04", "05", "06", "07","08","09", "10", "11", "12", "13", "14", "15"), col=col.rainbow, cex=.75, xpd=NA)
  text(y30_temp[15:30], y30_precip[15:30], labels=names)
#########
# calendar year
#########
  Ann_mn_ppt_cy <- c(mean(Wen_00_mn_ppt[3:367]), mean(Wen_01_mn_ppt[3:367]), mean(Wen_02_mn_ppt[3:367]), mean(Wen_03_mn_ppt[3:367]), mean(Wen_04_mn_ppt[3:367]), mean(Wen_05_mn_ppt[3:367]), mean(Wen_06_mn_ppt[3:367]), mean(Wen_07_mn_ppt[3:367]), mean(Wen_08_mn_ppt[3:367]), mean(Wen_09_mn_ppt[3:367]), mean(Wen_10_mn_ppt[3:367]), mean(Wen_11_mn_ppt[3:367]), mean(Wen_12_mn_ppt[3:367]), mean(Wen_13_mn_ppt[3:367]), mean(Wen_14_mn_ppt[3:367]), mean(Wen_15_mn_ppt[3:367]))
  ...
  for (k in 0:6)
    {
      ...
      yr2 <- paste0("0", k+1)
        ...
        data.out <- data.frame(pts, extract(rRaster1, pts))
        data.out[data.out[,3] < 0, 3] <-  0
...
############ to read in files once they've been processed #############
...
#####
    ...
    lister <- mget(paste0("Tmp_Wen_", 1981:2015))
    rm(list=ls(lister))
    
    lister <- mget(paste0("Ppt_Wen_", 1981:2015))
    rm(list=ls(lister))
    
    lister <- lapply(ls(pattern="Tmp_Wen_"), get)
    all <- do.call(rbind, lister)
    y00_15_wy_Tmp <- rowMeans(all[1:15,])
    
    lister <- lapply(ls(pattern="Ppt_Wen_"), get)
    all <- do.call(rbind, lister)
    y00_15_wy_Ppt <- rowMeans(all[1:15,])
  
    plot(Ppt_Wen_0001[3:367], pch=16, col="cornflowerblue", cex=.7, xaxt="n", main = "Cumulative mean precip (mm) by water-year, Wen 2000-2015", xlab="Sept-Aug", ylab="Precip", ylim=c(0,1500))
    points(Ppt_Wen_0102[3:367], pch=16, col="cyan4", cex=.7)
    points(Ppt_Wen_0203[3:367], pch=16, col="khaki", cex=.7)
    points(Ppt_Wen_0304[3:367], pch=16, col="deeppink4", cex=.7)
    points(Ppt_Wen_0405[3:367], pch=16, col="deeppink", cex=.7)
    points(Ppt_Wen_0506[3:367], pch=16, col="darkgrey", cex=.7)
    points(Ppt_Wen_0607[3:367], pch=16, col="lightblue", cex=.7)
    points(Ppt_Wen_0708[3:367], pch=16, col="red", cex=.7)
    points(Ppt_Wen_0809[3:367], pch=16, col="palevioletred", cex=.7)
    points(Ppt_Wen_0910[3:367], pch=16, col="darkgoldenrod1", cex=.7)
    points(Ppt_Wen_1011[3:367], pch=16, col="blueviolet", cex=.7)
    points(Ppt_Wen_1112[3:367], pch=16, col="lightgrey", cex=.7)
    points(Ppt_Wen_1213[3:367], pch=16, col="darkolivegreen4", cex=.7)
    points(Ppt_Wen_1314[3:367], pch=16, col="darkturquoise", cex=.7)
    points(Ppt_Wen_1415[3:367], pch=16, col="chartreuse2", cex=.7)
    ...
    plot(Tmp_Wen_0001[3:367], pch=16, col="cornflowerblue", cex=.7, xaxt="n", main = "Mean cumulative temp by water-year, Wen 2000-2015", xlab="Sept-Aug", ylab="Precip", ylim=c(0,3200))
    points(Tmp_Wen_0102[3:367], pch=16, col="cyan4", cex=.7)
    points(Tmp_Wen_0203[3:367], pch=16, col="khaki", cex=.7)
    points(Tmp_Wen_0304[3:367], pch=16, col="deeppink4", cex=.7)
    points(Tmp_Wen_0405[3:367], pch=16, col="deeppink", cex=.7)
    points(Tmp_Wen_0506[3:367], pch=16, col="darkgrey", cex=.7)
    points(Tmp_Wen_0607[3:367], pch=16, col="lightblue", cex=.7)
    points(Tmp_Wen_0708[3:367], pch=16, col="red", cex=.7)
    points(Tmp_Wen_0809[3:367], pch=16, col="palevioletred", cex=.7)
    points(Tmp_Wen_0910[3:367], pch=16, col="darkgoldenrod1", cex=.7)
    points(Tmp_Wen_1011[3:367], pch=16, col="blueviolet", cex=.7)
    points(Tmp_Wen_1112[3:367], pch=16, col="lightgrey", cex=.7)
    points(Tmp_Wen_1213[3:367], pch=16, col="darkolivegreen4", cex=.7)
    points(Tmp_Wen_1314[3:367], pch=16, col="darkturquoise", cex=.7)
    points(Tmp_Wen_1415[3:367], pch=16, col="chartreuse2", cex=.7)
  ...
  Ann_mn_temp_wy <- c(mean(Wen_0001_mn_tmp), mean(Wen_0102_mn_tmp), mean(Wen_0203_mn_tmp), mean(Wen_0304_mn_tmp), mean(Wen_0405_mn_tmp), mean(Wen_0506_mn_tmp), mean(Wen_0607_mn_tmp), mean(Wen_0708_mn_tmp), mean(Wen_0809_mn_tmp), mean(Wen_0910_mn_tmp), mean(Wen_1011_mn_tmp), mean(Wen_1112_mn_tmp), mean(Wen_1213_mn_tmp), mean(Wen_1314_mn_tmp), mean(Wen_1415_mn_tmp))
...
#################################################################
  ...
  coeffs_out <- data.frame(Int=numeric(1), bLST=numeric(1), bLST2=numeric(1), bElev=numeric(1))
  ...
  sum_mod <- summary(mod)
  pred.y <- predict(mod)
  plot(y, pred.y, main = "8-day Mean Full Year")
  abline(0,1)
...
############ pred plots ############
  ...
  preds <- read.csv(file=paste0(basin, "_01_15_annual_model_preds.csv"), stringsAsFactors = FALSE)
  
  preds$yrfactor <- as.factor(preds$Year)
  preds$JulDay <- sprintf("%03d", preds$JulDay)
  
  
  preds$yrDay <- as.numeric(paste0(preds$Year, preds$JulDay))
  plot(preds$yrDay, preds$Y)
  plot(preds$JulDay, preds$PredY, col=preds$yrfactor)
...
########################################################################################################
  ...
  setwd(outPath)
  coeffs.in <- read.csv(file=paste0(basin, "_01_15_annual_model_coeffs.csv"), stringsAsFactors = FALSE)
  ...
  for (i in 1:length(rcas))  
    {
      x <- unlist(LST.sum[i,1:46])
      
      out <- x* coeffs$bLST  +  LST.sum[i,47] * coeffs$bElev + x^2 * coeffs$bLST2 + coeffs$Int
    
     
      LogPred.out[i,1:46] <- out
    }
...
###########################
  # reading in the predt for a site across years
##########################
   i <- 2001
  setwd(paste0(mainPath, i))
  predt.in <- read.dbf(file = paste0("predt", i, "_", basin, "_8D_Mn.dbf"))
  
  site.pred <- unlist(predt.in[predt.in$RCAID == 260,])
  all.years <- site.pred
  ...
  for (i in 2002:2015)
    {
      ...
      site.pred <- unlist(predt.in[predt.in$RCAID == 260,])
      all.years <- rbind(all.years, site.pred)
    }
  
  all.years <- as.data.frame(all.years)
  all.years$year <- 1:15
  mxMn <- row.max(all.years[,1:46])
                        
  setwd(outPath)
  
  write.csv(all.years, file=paste0(basin, "_01_15_predt_RCA_260.csv"))
  
  years.in <- read.csv(file=paste0(basin, "_01_15_predt_RCA_260.csv"))
  
  years.in$label="Hot/Dry"
  years.in$label[years.in$climate =="CD"]="Cool/Dry"
  years.in$label[years.in$climate =="CW"]="Cool/Wet"
  years.in$label[years.in$climate =="WW"]="Warm/Wet"
  
  boxplot(maxMn ~ label, data = years.in, main = paste("Max mean stream temp by climate-year (2001-2015)"), xlab = "Climate-year", ylab = "max Mean stream temperature")
  ...
  abline(0,0, lty = 2)
  plot(years.in$year, years.in$maxMn, pch=16, col=years.in$climate, cex = 1.5, main)
  legend('bottomleft', legend = levels(years.in$climate), col = 1:4, cex = 0.8, pch = 16)
###########################
# water year
############################
