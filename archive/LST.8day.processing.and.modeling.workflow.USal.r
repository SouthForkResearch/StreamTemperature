...
#################################################################
  ...
  Log.in <- read.csv(paste0(basin, "_", yearPath, "_all_sites_data.csv"), stringsAsFactors = FALSE)
  ...
  write.csv(x=NoNA.xyz, file= paste0(basin, "_", yearPath, "_8Day_Mn_model_data.csv"), sep=",", row.names = FALSE)
