...
library(ggplot2)
  ...
  mainPath2 <- "D:/OneDrive/work/GIS/8_day_1km_LST/"
  
#############  this part fills in any gaps in the LST data using a cubic spline interpolation #########
...
####################################################################
  ...
  for(i in rcas)  
    {
      pixels <- weights[weights$rca_id == i, "GrPolyID"]
