...
#################################################################
  ...
  plot(namesnum, LogPred.out[1000,1:46])
...
# Edited 5 may 2016 to add animation output
 ...
 ################################################
  ...
  for (i in 3:48)
    {
      ...
      fix3 <- classIntervals(network@data[,i], n = 10, style = "fixed",fixedBreaks=c(-1,2,4,6,8,10,12,14,16,18))
  ...
  system('"C:/Program Files/ImageMagick-7.0.1-Q16/convert.exe" -delay 20 -morph 3 *.png Pahs_2012_8D_mn.mpeg')
