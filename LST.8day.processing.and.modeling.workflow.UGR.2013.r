...
setwd("D:/OneDrive/work/research/CHaMP/CHaMP_data/EP_temp/shapes/")
  ...
  LST.in <- read.dbf("UGR_13_LST.dbf")
  PointID <- LST.in[,1]
  LST.in <- LST.in[,2:47]
  ...
  write.dbf(LST.out, file = "LST13_UGR_interp.dbf")
...
####################################################################
  ...
  setwd("D:/OneDrive/work/research/CHaMP/CHaMP_data/EP_temp/UGR/")
  out_Preds <- read.dbf("LST13_UGR_interp.dbf") #use the appropriate read statemUGR
...
write.dbf(rca_zonal, file = "LST13_UGR_RCA.dbf")
...
#################################################################
  ...
  LST.in <- read.dbf("LST13_UGR_RCA.dbf")
  ...
  Log.in <- read.csv("UGR_2013_8DMax_logger.csv")
  ...
  for (i in SiteID) 
    ...
    write.csv(x=NoNA.xyz, file="UGR_2013_8Day_model_data.csv", row.names = FALSE)
...
###############################
  ...
  write.table (x=pred.out,append=T,row.names=F,file="jk_pred_v_y_UGR_2013_summer_only.csv",sep = ",", col.names=F)  
...
###################################
  ...
  pred.out[,5] <- "2013"
  colnames(pred.out) <- c("Y", "PredY", "JulDay", "Season", "Year")
  write.table (x=pred.out,append=T,row.names=F,file="jk_pred_v_y_UGR_2013_full_year.csv",sep = ",", col.names=F)  
...
######################################
    ...
    pred.out[,5] <- "2013"
    colnames(pred.out) <- c("Y", "PredY", "JulDay", "Season", "Year")
    write.table (x=pred.out,append=F,row.names=F,file="jk_pred_v_y_UGR_2013_sp_fall.csv",sep = ",", col.names=F)  
    ...
    write.table (x=pred.out,append=T,row.names=F,file="jk_pred_v_y_UGR_2013_sp_fall.csv",sep = ",", col.names=F)  
...
write.table(x=coeffs_out, append=F,row.names=T, file = "Summer_data_2013_mod_coeffs_Mx.csv", sep = ",", col.names=T)

write.table(x=metrics_out, append=F,row.names=T, file = "Summer_data_2013_mod_metrics_Mx.csv", sep = ",", col.names=T)
...
########################################################################################################
  ...
  LST.in <- read.dbf("D:/OneDrive/work/research/CHaMP/CHaMP_data/EP_temp/UGR/LST13_UGR_RCA.dbf")
  colnames(LST.in)<-gsub("X", "", colnames(LST.in))
  newnamesnum <- as.numeric(substring(colnames(LST.in)[1:46],3,5))
  colnames(LST.in)[1:46] <- newnamesnum;
  ...
  coeffs.in <- read.csv("Summer_data_2013_mod_coeffs_Mx.csv")
...
-
  ...
  write.dbf(LogPred.out, file = "predt2013_UGR_8D_Max_summer.dbf") 
...
setwd(mainPath)
  ...
  Max.in <- read.dbf("predt2013_UGR_8D_Max_summer.dbf") 
...
write.dbf(SumSumm.out, file = "UGR_2013_21Jul_31Aug_max_summary_All.dbf")
#write.csv(SumSumm.out, file = "UGR_2013_21Jul_31Aug_max_summary_All.csv", row.names = F)
...
write.csv(SumAU.out, file = "UGR_AU_2013_21Jul_31Aug_ExPcnt_summary_CHNK_All.csv", row.names = F)
...
colnames(SumAU.out) <- c("v12DMax", "v13DMax", "v16DMax", "v18DMax", "v20DMax", "v22DMax", "MnMax", "SeMnMx", "AU_Code")
write.csv(SumAU.out, file = "UGR_AU_2013_21Jul_31Aug_ExPcnt_summary_CHNK_IP.csv", row.names = F)
...
colnames(SumAU.out) <- c("v12DMax", "v13DMax", "v16DMax", "v18DMax", "v20DMax", "v22DMax", "MnMax", "SeMnMx", "AU_Code")
write.csv(SumAU.out, file = "UGR_AU_2013_21Jul_31Aug_ExPcnt_summary_STHD_All.csv", row.names = F)
...
colnames(SumAU.out) <- c("v12DMax", "v13DMax", "v16DMax", "v18DMax", "v20DMax", "v22DMax", "MnMax", "SeMnMx", "AU_Code")
write.csv(SumAU.out, file = "UGR_AU_2013_21Jul_31Aug_ExPcnt_summary_STHD_IP.csv", row.names = F)
...
Aus <- unique(ST_rcas$AU_STHD)
rcas <- unique(ST_rcas$RCAID)
#_______________________________
Aus <- unique(CH_rcas$AU_CHNK)
...
write.dbf(SumSumm.out, file = "UGR_2013_21Jul_31Aug_max_summary_CHNK_redo.dbf")
write.csv(SumSumm.out, file = "UGR_2013_21Jul_31Aug_max_summary_CHNK_redo.csv", row.names = F)
...
colnames(SumAU.out) <- c("v12DMax", "v13DMax", "v16DMax", "v18DMax", "v20DMax", "v22DMax", "MnMax", "SeMnMx", "AU_Code")
write.csv(SumAU.out, file = "UGR_AU_2013_21Jul_31Aug_ExPcnt_summary_CHNK_redo.csv", row.names = F)
...
Aus <- as.character(Aus)
  ...
  for (i in 1:length(Aus)) 
    { 
      ...
      filename <- paste0("D:/OneDrive/work/research/CHaMP/graphics/EP/UGR/2013/PctD18/CHNK/", name, "_18CHNK.png", sep="")
